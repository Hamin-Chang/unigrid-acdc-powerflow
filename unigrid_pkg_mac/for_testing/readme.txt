unigrid_pkg_mac MATLAB Python Package
...
2. Installing the unigrid_pkg_mac Package

A. Change to the directory that contains the file setup.py and the subdirectory 
unigrid_pkg_mac. If you do not have write permissions, copy all its contents to a 
...
3. Using the unigrid_pkg_mac Package
...
The unigrid_pkg_mac package is on your Python path. To import it into a Python script or 
session, execute:

    import unigrid_pkg_mac
