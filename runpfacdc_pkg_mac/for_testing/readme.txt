runpfacdc_pkg_mac MATLAB Python Package
...
2. Installing the runpfacdc_pkg_mac Package

A. Change to the directory that contains the file setup.py and the subdirectory 
runpfacdc_pkg_mac. If you do not have write permissions, copy all its contents to a 
...
3. Using the runpfacdc_pkg_mac Package
...
The runpfacdc_pkg_mac package is on your Python path. To import it into a Python script 
or session, execute:

    import runpfacdc_pkg_mac
