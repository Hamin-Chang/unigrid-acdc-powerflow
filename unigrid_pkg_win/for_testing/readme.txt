unigrid_pkg_win MATLAB Python Package
...
2. Installing the unigrid_pkg_win Package

A. Change to the directory that contains the file setup.py and the subdirectory 
unigrid_pkg_win. If you do not have write permissions, copy all its contents to a 
...
3. Using the unigrid_pkg_win Package

The unigrid_pkg_win package is on your Python path. To import it into a Python script or 
session, execute:

    import unigrid_pkg_win
