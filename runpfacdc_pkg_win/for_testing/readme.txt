runpfacdc_pkg_win MATLAB Python Package
...
2. Installing the runpfacdc_pkg_win Package

A. Change to the directory that contains the file setup.py and the subdirectory 
runpfacdc_pkg_win. If you do not have write permissions, copy all its contents to a 
...
3. Using the runpfacdc_pkg_win Package

The runpfacdc_pkg_win package is on your Python path. To import it into a Python script 
or session, execute:

    import runpfacdc_pkg_win
